...
granularity: each sample hit covers 2 byte(s) for 0.02% of 40.29 seconds

index % time    self  children    called     name
                                                 <spontaneous>
[1]     95.0    0.46   37.80                 main [1]
                0.00   37.30       1/1           train [2]
                0.50    0.00       1/1           test [5]
                0.00    0.00       3/3           read_large [8]
-----------------------------------------------
                0.00   37.30       1/1           main [1]
[2]     92.6    0.00   37.30       1         train [2]
               37.21    0.00       2/2           step4 [3]
                0.09    0.00       2/2           step2 [6]
                0.00    0.00       2/2           step1 [9]
                0.00    0.00       2/2           step3 [10]
-----------------------------------------------
               37.21    0.00       2/2           train [2]
[3]     92.3   37.21    0.00       2         step4 [3]
-----------------------------------------------
                                                 <spontaneous>
[4]      5.0    2.03    0.00                 matrix_mul_thread [4]
-----------------------------------------------
                0.50    0.00       1/1           main [1]
[5]      1.2    0.50    0.00       1         test [5]
-----------------------------------------------
                0.09    0.00       2/2           train [2]
[6]      0.2    0.09    0.00       2         step2 [6]
-----------------------------------------------
                0.00    0.00       3/3           read_large [8]
