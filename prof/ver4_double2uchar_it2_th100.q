...
granularity: each sample hit covers 2 byte(s) for 0.05% of 21.35 seconds

index % time    self  children    called     name
                                                 <spontaneous>
[1]     93.6    0.24   19.74                 main [1]
                0.00   19.19       1/1           train [2]
                0.55    0.00       1/1           test [5]
                0.00    0.00       3/3           read_large [8]
-----------------------------------------------
                0.00   19.19       1/1           main [1]
[2]     89.9    0.00   19.19       1         train [2]
               19.16    0.00       2/2           step4 [3]
                0.03    0.00       2/2           step2 [6]
                0.00    0.00       2/2           step1 [9]
                0.00    0.00       2/2           step3 [10]
-----------------------------------------------
               19.16    0.00       2/2           train [2]
[3]     89.7   19.16    0.00       2         step4 [3]
-----------------------------------------------
                                                 <spontaneous>
[4]      6.4    1.37    0.00                 matrix_mul_thread [4]
-----------------------------------------------
                0.55    0.00       1/1           main [1]
[5]      2.6    0.55    0.00       1         test [5]
-----------------------------------------------
